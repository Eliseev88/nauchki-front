                ...
                <div className={(isActiveBurgerMenu ? `${cl.header__wrapper} ${cl.active}` : cl.header__wrapper)}>
                    ...
                    <nav className={(isActiveBurgerMenu ? `${cl.header__nav} ${cl.active}` : cl.header__nav)}>
                        <div className={cl.header__icons}>
                            <NavLink to="/" className={cl.header__icon} onClick={handleNavLinkClick} title="На главную"><Home className={cl.header__svg} /></NavLink>
                            <NavLink to='/profile' className={cl.header__icon} onClick={handleNavLinkClick} title="Профиль"><Login className={cl.header__svg} /></NavLink>
                        </div>
